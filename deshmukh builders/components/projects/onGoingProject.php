...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="#">On-Going Project</a>
            <a href="complitedProject.php">Completed Project</a>
        </nav>
    ...
    <div class="container">
        <h3 class="title"> On-Going ProjectS </h3>
        ...
        <div class="container1">
            <div class="row">
                ...
                <div class="footer-col">
                    <h4>Our Project</h4>
                    <ul>
                        <li><a href="complitedProject.php">Completed project</a></li>
