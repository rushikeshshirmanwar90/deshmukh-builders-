...
if (isset($_POST['add_project'])) {
    ...
    if (empty($id) || empty($name) || empty($desc) || empty($image)) {
        ...
        $sql = "INSERT INTO `past_project`  (`id`, `name`, `des`, `image`, `location`, `yt`, `short`, `pdf`) VALUES ( '$id', '$name', '$desc', '$image', '$location', '$yt', '$shortDesc', '$pdf')";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM past_project WHERE id = $id";
...
if (!isset($_SESSION['AdminLoginId'])) {
    header("location: pastLonginForm.php");
}
...
<head>
    ...
    <title>(ADMIN) Completed project</title>
</head>
...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="continueProject.php">a-On_Going Project</a>
    ...
    <div class="container">
        <div class="admin-product-form-container">
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                <h3>add <span style="color: #002245;"> Completed </span> Project</h3>
            ...
            <table class="product-display-table">
                ...
                <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="pastUpdate.php?edit=<?php echo $row['id'] ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
                            <a href="pastProject.php?delete=<?php echo $row['id'] ?>" class="delete"> <i class="fas fa-trash"></i>delete</a>
                        </td>
                    </tr>
                <?php }; ?>
            </table>
